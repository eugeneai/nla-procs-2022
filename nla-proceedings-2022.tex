...
\input{AntipinaBulatovBiryukov-r}

 \begin{englisharticle}
\input{Arguchintsev_Poplevko-e}
\end{englisharticle}


\input{aristov-r}

\input{Artemeva_Korpusov-r}

 \begin{englisharticle}
\input{Averboukh_Khlopin-e}
\end{englisharticle}
...
\input{Berdyshev_Kostousov_Popov-r}

\input{Bondar-Mingnarov-r}
...
\input{Grazhdantseva,Solodusha-r}
...
\input{Kosov_Semenov-r}

 \begin{englisharticle}
\input{Kuznezov_Pechen-e}
\end{englisharticle}


\input{Ladeyshchikov-r-f}
...
\input{Obukhovskii_Petrosyan_Soroca-r}
...
\input{SkvortsovaMA-r}

\input{SolovarovaLS-r}
...
\end{englisharticle}
 ...
 \begin{englisharticle}
\input{Zabotin-Kazaeva-e}
\end{englisharticle}


 \begin{englisharticle}
\input{zabotin-yarullin-e}
\end{englisharticle}
